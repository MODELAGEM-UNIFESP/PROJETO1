...
int main(void){
    ...
    for(i = 0; i < 5; i++) scanf("%d", &Vparam[i]);
    printf("Parametros H1:\n");
    for(i = 0; i < 4; i++) scanf("%d", &H1param[i]);
    printf("Parametros H2:\n");
    for(i = 0; i < 4; i++) scanf("%d", &H2param[i]);
    printf("Parametros C1:\n");
    for(i = 0; i < 3; i++) scanf("%d", &C1param[i]);
    printf("Parametros C2:\n");
    for(i = 0; i < 3; i++) scanf("%d", &C2param[i]);

    printf("teste: %d", grama(Aold, Vparam));
}
